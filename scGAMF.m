function [similarity,g,w,objValue_residual,objValue] = scGAMF(X,layers,lambda,k,beta,lambda1,miu,ith)
...
%         CC{i}{1}=ZZ{i}{2};
%     end
%     [similarity,C,g,w,objValue_residual,objValue]=KSLS(CC,v,1,n, lambda1,beta,miu);%layers=1
    %% 利用第一层的输出
%     for i=1:v
%         CC{i}{1}=ZZ{i}{1};
%     end 
